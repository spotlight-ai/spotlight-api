...
from resources.pii.pii_columnar import ColumnarPII
from resources.pii.pii_columnar import ColumnarPIICollection
...
def create_app(config):
    ...
    api.add_resource(ColumnarPIICollection, "/pii/columnar_file")
    api.add_resource(ColumnarPII, "/pii/columnar_file/<int:dataset_id>")
