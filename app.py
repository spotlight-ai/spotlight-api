...
from resources.pii.file import (
    FilePII,
    FilePIICollection
)
...
from resources.workspaces.workspace_invitation import WorkspaceInvitation, WorkspaceInvitationAccept
...
def create_app(config):
    ...
    api.add_resource(FilePIICollection, "/file/<int:file_id>/marker")
    api.add_resource(FilePII, "/file/<int:file_id>/marker/<int:marker_id>")
    ...
    api.add_resource(WorkspaceInvitation, "/workspace/<string:workspace_name>/invite")
    api.add_resource(WorkspaceInvitationAccept, "/workspace/<string:workspace_name>/invite/accept")
