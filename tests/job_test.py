...
class JobResourceTest(BaseTest):
    ...
    def test_change_job_status_user(self):
        ...
        self.client().post(f'{self.job_route}/1', headers=header_user3, json={'dataset_id': 1})

        res = self.client().patch(f'{self.job_route}/1', headers=header_user3, json={'user_id': 3,
                                                                                     'job_id': 1,
                                                                                     'job_status': "FAILED"})
        self.assertEqual(res.status_code, 401)
    ...
    def test_change_job_status_model(self):
        ...
        res1 = self.client().patch(f'{self.job_route}/1', headers=header_model, json={'user_id': 3,
                                                                                      'job_id': 2,
                                                                                      'job_status': "FAILED"})

        res2 = self.client().patch(f'{self.job_route}/2', headers=header_model, json={'user_id': 3,
                                                                                      'job_id': 2,
                                                                                      'job_status': "COMPLETE"})

        res3 = self.client().patch(f'{self.job_route}/3', headers=header_model, json={'user_id': 3,
                                                                                      'job_id': 3,
                                                                                      'job_status': "PENDING"})
