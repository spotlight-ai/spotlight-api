...
class JobResourceTest(BaseTest):
    ...
    def test_change_job_status_user(self):
        ...
        res = self.client().patch(f'{self.job_route}/1', headers=header_user3, json={
            'user_id': 3,
            'job_id': 1,
            'job_status': "FAILED"
        })
    ...
    def test_change_job_status_model(self):
        ...
        res1 = self.client().patch(f'{self.job_route}/1', headers=model_header, json={
            'user_id': 3,
            'job_id': 2,
            'job_status': "FAILED"
        })
        
        res2 = self.client().patch(f'{self.job_route}/2', headers=model_header, json={
            'user_id': 3,
            'job_id': 2,
            'job_status': "COMPLETE"
        })
