...
class RoleMemberResourceTest(BaseTest):
    ...
    def test_replace_combo(self):
        ...
        res = self.client().put(f'{self.role_route}/1/member', json={'owners': [2, 3], 'users': [4]}, headers=headers)
    ...
    def test_add_existing_combo(self):
        ...
        res = self.client().post(f'{self.role_route}/1/member', json={'owners': [4], 'users': [2]}, headers=headers)
    ...
    def test_wrong_key(self):
        ...
        self.assertIn('Body must have only the accepted keys: [\'owners\', \'users\']', res.data.decode())
    
    def test_delete_all_owners(self):
        """Validates that an error is thrown when all owners are deleted."""
        headers = self.generate_auth_headers(user_id=4)
        
        res = self.client().delete(f'{self.role_route}/1/member', json={'owners': [3, 4], 'members': []},
                                   headers=headers)
    ...
    def test_delete_owner(self):
        ...
        res = self.client().delete(f'{self.role_route}/1/member', json={'owners': [3], 'members': []},
                                   headers=headers)
    ...
    def test_delete_combo(self):
        ...
        res = self.client().delete(f'{self.role_route}/1/member', json={'owners': [3], 'members': [1]},
                                   headers=headers)
