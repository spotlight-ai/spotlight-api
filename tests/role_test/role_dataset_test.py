...
class RoleDatasetResourceTest(BaseTest):
    ...
    def test_add_multiple_datasets(self):
        ...
        res = self.client().post(f'{self.role_route}/1/dataset', headers=headers,
                                 json={'datasets': [2, 3]})
    ...
    def test_update_role_datasets(self):
        ...
        res = self.client().put(f'{self.role_route}/1/dataset', json={'datasets': [1, 2]}, headers=headers)
    ...
    def test_remove_role_dataset(self):
        ...
        res = self.client().delete(f'{self.role_route}/1/dataset', json={'datasets': [1]}, headers=headers)
    ...
    def test_remove_missing_dataset(self):
        ...
        res = self.client().delete(f'{self.role_route}/1/dataset', json={'datasets': [1, 2]}, headers=headers)
